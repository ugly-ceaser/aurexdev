        ...
        <div className="relative glass-panel-heavy rounded-[32px] p-8 shadow-2xl">
          <div className="text-center space-y-4 mb-8">
            ...
            <p className="text-sm font-light text-gray-400">
              Create a secure new password for your telemetry vault
            </p>
          </div>

          {!token ? (
            <div className="px-4 py-3 rounded-2xl text-xs font-semibold border bg-red-500/10 border-red-500/30 text-rose-600 text-center">
              Recovery token is invalid or missing. Please trigger a new email recovery link.
            </div>
          ) : (
